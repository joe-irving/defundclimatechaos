...
{% capture target %}https://actionnetwork.org/letters/email-the-bank-of-england?source=dccuk_website_{{ page.url | slugify }}&{{ "https://defundclimatechaos.uk/banks/barclays/#email-thank-you" | url_encode  }}{% endcapture %}
